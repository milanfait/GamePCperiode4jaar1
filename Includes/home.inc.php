...
<!--    <div class="position-absolute top-0 start-0 w-100 h-100 bg-dark bg-opacity-75"></div>-->
  ...
  <section id="join" class="py-5 text-center">
    <div class="container">
      <h2 class="mb-4">Ready to upgrade your gaming experience?</h2>
      <p class="mb-4 fs-5">Get the help you need to switch from console to PC in no time.</p>
      <a href="?page=register" class="btn btn-primary btn-lg">Join the Community</a>
    </div>
  </section>
